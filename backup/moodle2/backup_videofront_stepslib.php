...
class backup_videofront_activity_structure_step extends backup_activity_structure_step {
    ...
    protected function define_structure() {
        ...
        // Define the root element describing the videofront instance.
        $videofront = new backup_nested_element('videofront', array('id'), array(
        ...
        // Return the root element (videofront), wrapped into standard activity structure.
